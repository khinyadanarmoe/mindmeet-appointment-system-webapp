...
const Header = () => {
  return (
    <div className="relative flex flex-col md:flex-row items-center bg-gradient-to-br from-purple-100 via-blue-90 to-white-50 min-h-[500px] md:min-h-[600px] overflow-hidden shadow-lg">
      ...
      <div className="text-gray-800 text-center md:text-left flex flex-col gap-8 md:w-1/2 max-w-lg px-4 md:px-16 py-12 z-20">
        <div>
          ...
          <p className="text-lg md:text-lg text-gray-600 leading-relaxed">
            Your Mental Health, Our Priority. At MindMeet, we connect you with
            trusted, certified professionals who genuinely care about your
            wellbeing and mental wellness journey. Whether you are seeking
            therapy, counseling, or guidance for stress, anxiety, or personal
            growth, our platform makes it simple to find the right professional
      ...
      {/* image section */}
      <div className="absolute right-0 top-0 w-full md:w-2/3 h-full hover:scale-105 transition-transform duration-500 ease-in-out">
        <img
